...
(* OASIS_START *)
(* DO NOT EDIT (digest: 17ac57f68dbf0b1478a7d4bee36a8dff) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "enable Unix-only parts";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "proto-vmnet";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "vmnet-client";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "proto-vmnet";
                           FindlibPackage ("fd-send-recv", None);
                           FindlibPackage ("ipaddr", None);
                           FindlibPackage ("unix-errno", None);
                           FindlibPackage ("unix-errno.unix", None);
                           FindlibPackage ("cstruct", None);
                           FindlibPackage ("cstruct.lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("logs", None)
                   ...
                   {
                      lib_modules = ["Vmnet_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "vmnet-client";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "P\2394\141y8-[!\160P-\242n\248\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
