...
(* OASIS_START *)
(* DO NOT EDIT (digest: 74c0fffdcc1a7f4913e1d7d5f1915ecf) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Active_list"; "Active_config"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ofs";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "~\020gIá®z¨\130\014\127\026Öñ¥î";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
