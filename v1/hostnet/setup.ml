...
(* OASIS_START *)
(* DO NOT EDIT (digest: b1897cc1c619c0958a8e92805a3b7ecb) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "a5p'\171\237\028m\161U\2184\201\185t\204";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
