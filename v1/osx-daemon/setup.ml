...
(* OASIS_START *)
(* DO NOT EDIT (digest: 08844eda09731186099bdd8feaf5be6f) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Osx_reporter"; "Osx_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "osx-daemon";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\024\136<\003§ \127lj\023Iàêp\"_";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
