...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9af3cf61f9aa847669c2d818f864538b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some [OASISText.Para "proxy ethernet frames to and from sockets"];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("osx-daemon", None);
                           FindlibPackage ("osx-hyperkit", None);
                           FindlibPackage ("ofs", None);
                           FindlibPackage ("protocol-9p", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\018Úb«Ãc¦Ö\000Ë@¶îòþ\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
