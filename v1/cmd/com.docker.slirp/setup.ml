...
(* OASIS_START *)
(* DO NOT EDIT (digest: 74de2c05900a4a069a4cf0042d504f4d) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("vmnet-client", None);
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "õ\140äs\148\004ßl=ü\158×¦6\015\001";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
