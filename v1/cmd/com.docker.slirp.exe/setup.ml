...
(* OASIS_START *)
(* DO NOT EDIT (digest: 566421336ca37dfb598f0cdc5e39f8ff) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("win-eventlog", None);
                           FindlibPackage ("named-pipe.lwt", None);
                           ...
                           FindlibPackage ("hvsock.lwt", None);
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "^^±²=\133W\149Ï°Õ²è\020\153@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
